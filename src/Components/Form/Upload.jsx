...
const Upload = (props) => {
  const { data, onChange, multiple, nameUrl, handleDeleteItem } = props
    ...
    <div className="box-file">
      ...
      {API_NAME.SLIDER === nameUrl && data.length ? (
        ...
        <>
          ...
          <label htmlFor="files" className="group__checkbox--title label-file">
            <span className="label-file__icon fas fa-plus" />
            <span className="label-file__text">Upload</span>
          </label>
        </>
      )}
    </div>
